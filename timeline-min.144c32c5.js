...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../static/timeline3/js/timeline-min.js":[function(require,module,exports) {
...
!function (t) {
  ...
  extend: function extend(t) {
    for (var e, i = Array.prototype.slice.call(arguments, 1), n = 0, a = i.length; a > n; n++) {
      e = i[n] || {}, TL.Util.mergeData(t, e);
    }

    return t;
  },
  isEven: function isEven(t) {
    return t == parseFloat(t) ? !(t % 2) : void 0;
  },
  isTrue: function isTrue(t) {
    return null == t ? !1 : 1 == t || "true" == String(t).toLowerCase() || 1 == Number(t);
  },
  findArrayNumberByUniqueID: function findArrayNumberByUniqueID(t, e, i, n) {
    for (var a = n || 0, s = 0; s < e.length; s++) {
      e[s].data[i] == t && (a = s);
    }

    return a;
  },
  convertUnixTime: function convertUnixTime(t) {
    var e,
        i,
        n,
        a,
    ...
    for (var h = 0; h < l.full_array.length; h++) {
      r.push(parseInt(l.full_array[h]));
    }
  ...
  getRandomNumber: function getRandomNumber(t) {
    return Math.floor(Math.random() * t);
  },
  unique_ID: function unique_ID(t, e) {
    var i = function i(t) {
      return Math.floor(Math.random() * t);
    },
        n = function n() {
  ...
  ensureUniqueKey: function ensureUniqueKey(t, e) {
    if (e || (e = TL.Util.unique_ID(6)), !(e in t)) return e;
    var i = e.match(/^(.+)(-\d+)?$/)[1],
        n = [];

    for (key in t) {
      key.match(/^(.+?)(-\d+)?$/)[1] == i && n.push(key);
    }

    e = i + "-" + (n.length + 1);

    for (var a = n.length; -1 != n.indexOf(e); a++) {
      e = i + "-" + a;
    }

    return e;
  },
  htmlify: function htmlify(t) {
    return t.match(/<p>[\s\S]*?<\/p>/) ? t : "<p>" + t + "</p>";
  },
  unhtmlify: function unhtmlify(t) {
    return t = t.replace(/(<[^>]*>)+/g, ""), t.replace('"', "'");
  },
  linkify: function linkify(t) {
    var e = function e(t, _e, i) {
      i || (i = "");
      var n = 30;
      return _e && _e.length > n && (_e = _e.substring(0, n) + "…"), i + "<a class='tl-makelink' href='" + t + "' onclick='void(0)'>" + _e + "</a>";
    },
  ...
  unlinkify: function unlinkify(t) {
    return t ? (t = t.replace(/<a\b[^>]*>/i, ""), t = t.replace(/<\/a>/i, "")) : t;
  },
  getParamString: function getParamString(t) {
    var e = [];
  ...
  rgbToHex: function rgbToHex(t) {
    var e, i, n;
    if ("object" == _typeof(t)) e = t.r, i = t.g, n = t.b;else if ("function" == typeof t.match) {
  ...
  colorObjToHex: function colorObjToHex(t) {
    var e = [t.r, t.g, t.b];
  ...
  getUrlVars: function getUrlVars(t) {
    var e,
        i,
        n,
        a = [];
    ...
    for (var s = 0; s < n.length; s++) {
      i = n[s].split("="), a.push(i[0]), a[i[0]] = i[1];
    }
  ...
  intToHexString: function intToHexString(t) {
    return TL.Util.pad(parseInt(t, 10).toString(16));
  },
  findNextGreater: function findNextGreater(t, e, i) {
  ...
  findNextLesser: function findNextLesser(t, e, i) {
  ...
  parseYouTubeTime: function parseYouTubeTime(t) {
    if ("string" == typeof t) {
  ...
  transformImageURL: function transformImageURL(t) {
  ...
  var e = function () {
    ...
    return G.matches = function (t, e) {
      ...
      if (!t) return G.Z();
      if ("string" == typeof t) {
        if (t = t.trim(), "<" == t[0] && A.test(t)) n = G.fragment(t, RegExp.$1, i), t = null;else {
      ...
      find: function find(t) {
        var e,
            i = this;
        return e = "object" == _typeof(t) ? $(t).filter(function () {
          var t = this;
      ...
      closest: function closest(t, e) {
        ...
        for ("object" == _typeof(t) && (a = $(t)); i && !(a ? a.indexOf(i) >= 0 : G.matches(i, t));) {
      ...
      attr: function attr(t, e) {
        ...
        return "string" == typeof t && e === L ? 0 == this.length || 1 !== this[0].nodeType ? L : "value" == t && "INPUT" == this[0].nodeName ? this.val() : !(i = this[0].getAttribute(t)) && t in this[0] ? this[0][t] : i : this.each(function (i) {
          if (1 === this.nodeType) if (a(t)) for (w in t) {
            g(this, w, t[w]);
          } else g(this, t, f(this, e, i, this.getAttribute(t)));
        });
      },
  ...
  window.Zepto = e, void 0 === window.$ && (window.$ = e), function ($) {
    ...
    function o(e, n, o, r, h, c, u) {
      ...
      n.split(/\s/).forEach(function (t) {
        ...
        var n = i(t);
        n.fn = o, n.sel = h, n.e in y && (o = function o(t) {
    ...
    $.active = 0, $.ajaxJSONP = function (t, e) {
      ...
      if (e.xhrFields) for (p in e.xhrFields) {
        T[p] = e.xhrFields[p];
      }
  ...
  for (var a in this) {
    this.hasOwnProperty(a) && "prototype" !== a && "superclass" !== a && (e[a] = this[a]);
  }
  ...
  fireEvent: function fireEvent(t, e) {
    ...
    for (var i = TL.Util.mergeData({
      type: t,
      target: this
    }, e), n = this._tl_events[t].slice(), a = 0, s = n.length; s > a; a++) {
      n[a].action.call(n[a].context || this, i);
    }
  ...
  var e = [];
  return {
    css: function css(e, i, n, a) {
      t(e) ? i() : TL.LoadIt.css(e, i, n, a);
    },
    js: function js(e, i, n, a) {
  ...
  function e(e, i) {
    ...
    for (n in i) {
      i.hasOwnProperty(n) && a.setAttribute(n, i[n]);
    }
  ...
  function a(a, d, u, m, _) {
    ...
    if (!h[a] && (v = h[a] = c[a].shift())) {
      for (l || (l = t.head || t.getElementsByTagName("head")[0]), y = v.urls, p = 0, f = y.length; f > p; ++p) {
        T = y[p], w ? g = r.gecko ? e("style") : e("link", {
          href: T,
          rel: "stylesheet"
        }) : (g = e("script", {
          src: T
  ...
  initialize: function initialize(t) {
    if (this.title = "", this.scale = "", this.events = [], this.eras = [], this.event_dict = {}, this.messages = {
      ...
      if (t.eras) for (var i = 0; i < t.eras.length; i++) {
        try {
  ...
  logError: function logError(t) {
    trace(t), this.messages.errors.push(t);
  },
  getErrors: function getErrors(t) {
  ...
  _makeUniqueIdentifiers: function _makeUniqueIdentifiers(t, e) {
    for (var i = [t], n = 0; n < e.length; n++) {
      TL.Util.trim(e[n].unique_id) && (e[n].unique_id = TL.Util.slugify(e[n].unique_id), -1 == i.indexOf(e[n].unique_id) ? i.push(e[n].unique_id) : e[n].unique_id = "");
    }

    if (i.length != e.length + 1) for (var n = 0; n < e.length; n++) {
      if (!e[n].unique_id) {
  ...
  _ensureValidScale: function _ensureValidScale(t) {
    if (!this.scale) {
  ...
  _processDates: function _processDates(t) {
  ...
  getLatestDate: function getLatestDate() {
    ...
    for (var e = 0; e < this.eras.length; e++) {
      t.push(this.eras[e].end_date ? {
  ...
  _tidyFields: function _tidyFields(t) {
    function e(t, e, i) {
  ...
  function e(t) {
    ...
    var e = /\bkey=([-_A-Za-z0-9]+)&?/i,
        i = /docs.google.com\/spreadsheets(.*?)\/d\//;
    if (t.match(e)) parts.key = t.match(e)[1];else if (t.match(i)) {
      var n = t.search(i) + t.match(i)[0].length,
          a = t.substr(n);
  ...
  function i(e) {
    ...
    for (k in e) {
      0 == k.indexOf("gsx$") && (i[k.substr(4)] = e[k].$t);
    }
  ...
  function n(e) {
    ...
    for (k in e) {
      0 == k.indexOf("gsx$") && (n[k.substr(4)] = t.Util.trim(e[k].$t));
    }
  ...
  function a(e, i) {
    ...
    for (var a = {}, s = 1; s < i.length; s++) {
      if (e.length >= s) {
        var o = e[s].toLowerCase().replace(" ", "");
        a[o] = i[s];
      }
    }
    ...
    if (a.time && t.Util.mergeData(r.start_date, t.DateUtil.parseTime(i[3])), a.endtime && t.Util.mergeData(r.end_date, t.DateUtil.parseTime(a.endtime)), a.group && (r.group = a.group), "" == r.end_date.year) {
      var l = r.end_date;

      if (delete r.end_date, "" != l.month || "" != l.day || "" != l.time) {
        {
          r.text.headline || trace("Invalid end date for spreadsheet row. Must have a year if any other date fields are specified.");
        }
        trace(i);
      }
    }

    return a.background && (r.background = a.background.match(/^(https?:)?\/\/?/) ? {
      url: a.background
    } : {
      color: a.background
    }), r;
  ...
  var s = function s(e) {
    ...
    var n = "v3",
        a = e(i);
    if (!a || !a.key) throw new t.Error("invalid_url_err", i);
    var s = a.key,
        r = o(s, n),
        h = t.ajax({
      url: r,
    ...
    if (200 != h.status) {
      console.log("Error fetching data " + n + ": " + h.status + " - " + h.statusText), n = "v4";
      var r = o(s, n);
      console.log("trying v4 - " + i);
      var h = t.ajax({
        url: r,
        async: !1
      });
      if (403 == h.status) throw new t.Error("invalid_url_share_required");

      if (200 != h.status) {
        var d = "Error fetching data " + n + ": " + h.status + " - " + h.statusText;
        throw console.log(d), new t.Error("google_error", d);
      }
    }
    ...
    if (c.error) {
      var d = "Error fetching data " + n + ": " + h.status + " - " + h.statusText;
      throw console.log(d), console.log(c.error), new t.Error("google_error", d);
    }
    ...
    if (t.values) for (var i = 1; i < t.values.length; i++) {
      var n = a(t.values[0], t.values[i]);

      if (n) {
        var o = "event";
        "undefined" != typeof n.type && (o = n.type, delete n.type), "title" == o ? e.title ? (e.warnings.push("Multiple title slides detected."), e.events.push(n)) : e.title = n : "era" == o ? e.eras.push(n) : e.events.push(n);
      }
    } else for (var r = s(t), i = 0; i < t.feed.entry.length; i++) {
      try {
        var n = r(t.feed.entry[i]);
        ...
        l.message && (l = l.message), e.errors.push(l + " [" + i + "]");
      }
    }
    return e;
  },
    ...
    if (s) {
      ...
      if (a = new t.TimelineConfig(o), o.errors) for (var h = 0; h < o.errors.length; h++) {
        a.logError(o.errors[h]);
      }
      n(a);
    } else t.ajax({
      url: i,
  ...
  t.ConfigFactory = {
    ...
    googleFeedJSONtoTimelineJSON: l,
    fromGoogle: function fromGoogle(t) {
      return console.warn("TL.ConfigFactory.fromGoogle is deprecated and will be removed soon. Use TL.ConfigFactory.makeConfig(url,callback)"), r(t);
    },
    makeConfig: h
  };
  ...
  for (k in TL.Language.languages.en) {
    t[k] && ("object" == _typeof(this[k]) ? TL.Util.mergeData(t[k], this[k]) : this[k] = t[k]);
  }
  ...
  KeySpline: function KeySpline(t) {
    function e(t, e) {
      return 1 - 3 * e + 3 * t;
    }
  ...
  function u(t, e) {
    ...
    for (n = 1; a > n; ++n) {
      for (i = 0; a - n > i; ++i) {
        s[i][0] = (1 - e) * s[i][0] + e * s[parseInt(i + 1, 10)][0], s[i][1] = (1 - e) * s[i][1] + e * s[parseInt(i + 1, 10)][1];
      }
    }
  ...
  function m(t, e, i) {
    ...
    for (n = 0; 6 > n; n++) {
      s = Math.min(15, parseInt(e.charAt(n), 16)), o = Math.min(15, parseInt(i.charAt(n), 16)), a = Math.floor((o - s) * t + s), a = a > 15 ? 15 : 0 > a ? 0 : a, r[n] = a.toString(16);
    }
  ...
  function _(t, e, i, n, a, s, o) {
    if ("transform" == a) {
      ...
      for (var r in i[s][a]) {
        o[r] = r in n[s][a] ? Math.round(((n[s][a][r] - i[s][a][r]) * t + i[s][a][r]) * x) / x : i[s][a][r];
      }
  ...
  function f(t, e) {
    ...
    return c.apply(d, [f, function (t, n, a) {
      for (i = d.length; i--;) {
        ...
        for (var o in e) {
          n = _(t, L, y, T, o, i), "transform" == o ? d[i].style[A] = s(n) : "opacity" != o || U ? d[i].style[l(o)] = n : d[i].style.filter = "alpha(opacity=" + 100 * n + ")";
        }
      }
    }, m, g]);
  }
  ...
  divideBy: function divideBy(t, e) {
  ...
  animatePosition: function animatePosition(t, e) {
    var i = {
  ...
  createText: function createText(t, e) {
  ...
  addListener: function addListener(t, e, i, n) {
    ...
    if (!t[s]) {
      ...
      if (TL.Browser.touch && "dblclick" === e && this.addDoubleTapListener) this.addDoubleTapListener(t, o, a);else if ("addEventListener" in t) {
  ...
  _getEvent: function _getEvent() {
    var t = window.event;
    if (!t) for (var e = arguments.callee.caller; e && (t = e.arguments[0], !t || window.Event !== t.constructor);) {
      e = e.caller;
    }
    return t;
  },
  ...
  addRule: function addRule(t, e, i) {
    var n = 0;
  ...
  t.SCALES = [["millisecond", 1, function () {}], ["second", 1e3, function (t) {
    t.setMilliseconds(0);
  ...
  sortByDate: function sortByDate(t, e) {
    var e = e || "start_date";
    t.sort(function (t, i) {
  ...
  updateConstraint: function updateConstraint(t) {
  ...
  initialize: function initialize(t, e, i) {
    this._el = {
      ...
      coverbar: {},
      grip: {}
    }, this.collapsed = !1, this._el.container = "object" == _typeof(t) ? t : TL.Dom.get(t), e && (this._el.parent = e), this.options = {
      width: 600,
      height: 600,
      duration: 1e3,
      ease: TL.Ease.easeInOutQuint,
  ...
  hide: function hide() {},
  toogleZoomIn: function toogleZoomIn(t) {
  ...
  toogleZoomOut: function toogleZoomOut(t) {
  ...
  setSticky: function setSticky(t) {
  ...
  updateDisplay: function updateDisplay(t, e, i, n) {
    this._updateDisplay(t, e, i, n);
  },
  _onButtonZoomIn: function _onButtonZoomIn(t) {
    this.fire("zoom_in", t);
  },
  _onButtonZoomOut: function _onButtonZoomOut(t) {
    this.fire("zoom_out", t);
  },
  _onButtonBackToStart: function _onButtonBackToStart(t) {
  ...
  _updateDisplay: function _updateDisplay(t, e) {
  ...
  updateDisplay: function updateDisplay(t, e) {
  ...
  errorMessage: function errorMessage(t) {
    t = t ? this._("error") + ": " + t : this._("error"), this._updateMessage(t);
  },
  updateMediaDisplay: function updateMediaDisplay(t) {
  ...
  getImageURL: function getImageURL(t, e) {
    return this._getImageURL(t, e);
  },
  updateDisplay: function updateDisplay(t, e, i) {
    this._updateDisplay(t, e, i);
  },
  stopMedia: function stopMedia() {
    this._stopMedia();
  },
  loadErrorDisplay: function loadErrorDisplay(t) {
    try {
  ...
  _updateDisplay: function _updateDisplay(t, e, i) {
  ...
  _transformURL: function _transformURL(t) {
  ...
  getImageURL: function getImageURL(t, e) {
    for (var i = this.size_label(e), n = this.sizes[this.sizes.length - 2].source, a = 0; a < this.sizes.length; a++) {
      this.sizes[a].label == i && (n = this.sizes[a].source);
    }
  ...
  size_label: function size_label(t) {
    var e = "";
  ...
  getImageURL: function getImageURL(t) {
  ...
  makeGoogleMapsEmbedURL: function makeGoogleMapsEmbedURL(t, e) {
    function i(t) {
      function i(e, i) {
...
TL.Media.SoundCloud = TL.Media.extend({
  ...
  createMedia: function createMedia(t) {
  ...
  addDateText: function addDateText(t) {
  ...
  _loadMedia: function _loadMedia() {
    var t,
        e = this;
    if (this._el.content_item = TL.Dom.create("div", "tl-media-twitter", this._el.content), this._el.content_container.className = "tl-media-content-container tl-media-content-container-text", this.data.url.match("^(https?:)?/*(www.)?twitter.com")) this.media_id = this.data.url.match("status/") ? this.data.url.split("status/")[1] : this.data.url.match("statuses/") ? this.data.url.split("statuses/")[1] : "";else if (this.data.url.match("<blockquote class=['\"]twitter-tweet['\"]")) {
...
TL.Media.TwitterEmbed = TL.Media.extend({
  ...
  createMedia: function createMedia(t) {
    ...
    var e = "",
        ...
        s = "",
        o = "";
    i = t.html.split("</p>&mdash;")[0] + "</p></blockquote>", console.log(i), n = t.author_url.split("twitter.com/")[1], a = t.html.split("</p>&mdash;")[1].split('<a href="')[1], s = a.split('">')[0], o = a.split('">')[1].split("</a>")[0], i = i.replace(/<a href/gi, '<a target="_blank" href'), i.includes("pic.twitter.com") ? (twttr.ready(function () {
      e = document.getElementsByClassName("tl-media-twitter")[0];
      var t = String(mediaID);
      twttr.widgets.createTweet(t, e, {
        conversation: "none",
        linkColor: "#cc0000",
        theme: "light"
      }).then(function () {
  ...
  _loadMedia: function _loadMedia() {
    var t,
        e = this;
    this._el.content_item = TL.Dom.create("div", "tl-media-item tl-media-iframe tl-media-vimeo tl-media-shadow", this._el.content), this.media_id = this.data.url.split(/video\/|\/\/vimeo\.com\//)[1].split(/[?&]/)[0];
    var i = null;
    this.data.url.match(/#t=([^&]+).*/) && (i = this.data.url.match(/#t=([^&]+).*/)[1]), t = "https://player.vimeo.com/video/" + this.media_id + "?api=1&title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff", i && (t = t += "&amp;#t=" + i), this.player = TL.Dom.create("iframe", "", this._el.content_item), this.player.addEventListener("load", function () {
      e.onMediaLoaded();
  ...
  _setContent: function _setContent(t) {
  ...
  _getType: function _getType(t, e) {
    var i = t.match(e),
        n = "audio/";
  ...
  initialize: function initialize(t, e, i, n) {
    this._el = {
      ...
      dragging: !0,
      trackResize: !0
    }, "object" == _typeof(t) ? (this._el.container = t, this.options.id = TL.Util.unique_ID(6, "tl")) : (this.options.id = t, this._el.container = TL.Dom.get(t)), this._el.container.id || (this._el.container.id = this.options.id), this.animator = null, TL.Util.mergeData(this.options, i), TL.Util.mergeData(this.data, e), n && this.init();
  },
  init: function init() {
  ...
  _addSlide: function _addSlide(t) {
  ...
  _createSlide: function _createSlide(t, e, i) {
    var n = new TL.Slide(t, this.options, e);
    this._addSlide(n), 0 > i ? this._slides.push(n) : this._slides.splice(i, 0, n);
  },
  _createSlides: function _createSlides(t) {
    for (var e = 0; e < t.length; e++) {
      "" == t[e].unique_id && (t[e].unique_id = TL.Util.unique_ID(6, "tl-slide")), this._createSlide(t[e], !1, -1);
    }
  },
  _removeSlide: function _removeSlide(t) {
  ...
  _destroySlide: function _destroySlide(t) {
    this._removeSlide(this._slides[t]), this._slides.splice(t, 1);
  },
  _findSlideIndex: function _findSlideIndex(t) {
    var e = t;
  ...
  createSlide: function createSlide(t, e) {
    this._createSlide(t, !1, e);
  },
  createSlides: function createSlides(t) {
    this._createSlides(t);
  },
  destroySlide: function destroySlide(t) {
    this._destroySlide(t);
  },
  destroySlideId: function destroySlideId(t) {
    this.destroySlide(this._findSlideIndex(t));
  },
  goTo: function goTo(t, e, i) {
  ...
  goToId: function goToId(t, e, i) {
    this.goTo(this._findSlideIndex(t), e, i);
  },
  preloadSlides: function preloadSlides(t) {
  ...
  showNav: function showNav(t, e) {
    this.options.width <= 500 && TL.Browser.mobile || (e ? t.show() : t.hide());
  },
  changeBackground: function changeBackground(t) {
    var e,
        i = {
      r: 256,
      g: 256,
  ...
  _updateDisplay: function _updateDisplay(t, e, i, n) {
    var a, s;
    ...
    for (var o = 0; o < this._slides.length; o++) {
      this._slides[o].updateDisplay(this.options.width, this.options.height, s), this._slides[o].setPosition({
  ...
  _onBackgroundChange: function _onBackgroundChange(t) {
    var e = this._findSlideIndex(this.current_id),
        i = this._slides[e].getBackground();

    this.changeBackground(t), this.fire("colorchange", i);
  },
  _onMessageClick: function _onMessageClick() {
    this._message.hide();
  },
  _onSwipeNoDirection: function _onSwipeNoDirection() {
    this.goToId(this.current_id);
  },
  _onNavigation: function _onNavigation(t) {
  ...
  _onSlideAdded: function _onSlideAdded() {
    trace("slideadded"), this.fire("slideAdded", this.data);
  },
  _onSlideRemoved: function _onSlideRemoved() {
    this.fire("slideRemoved", this.data);
  },
  _onSlideChange: function _onSlideChange(t) {
    t || this.fire("change", {
  ...
  initialize: function initialize(t, e, i, n) {
    this._el = {
      ...
      timeaxis_background: {},
      attribution: {}
    }, this.collapsed = !1, this._el.container = "object" == _typeof(t) ? t : TL.Dom.get(t), this.config = e, this.options = {
      width: 600,
      height: 600,
      duration: 1e3,
      ease: TL.Ease.easeInOutQuint,
  ...
  setZoomFactor: function setZoomFactor(t) {
  ...
  _addGroup: function _addGroup(t) {
  ...
  _createMarkers: function _createMarkers(t) {
    for (var e = 0; e < t.length; e++) {
  ...
  _destroyMarker: function _destroyMarker(t) {
    this._removeMarker(this._markers[t]), this._markers.splice(t, 1);
  },
  _positionMarkers: function _positionMarkers(t) {
  ...
  _calculateMarkerHeight: function _calculateMarkerHeight(t) {
    return t / this.timescale.getNumberOfRows() - this.options.marker_padding;
  },
  _calculateRowHeight: function _calculateRowHeight(t) {
  ...
  createMarker: function createMarker(t, e) {
    this._createMarker(t, e);
  },
  createMarkers: function createMarkers(t) {
    this._createMarkers(t);
  },
  destroyMarker: function destroyMarker(t) {
    this._destroyMarker(t);
  },
  destroyMarkerId: function destroyMarkerId(t) {
  ...
  _onMarkerAdded: function _onMarkerAdded() {
    this.fire("dateAdded", this.config);
  },
  _onEraAdded: function _onEraAdded() {
    this.fire("eraAdded", this.config);
  },
  _onMarkerRemoved: function _onMarkerRemoved() {
  ...
  _onMouseScroll: function _onMouseScroll(t) {
    var e = 0,
        i = 0,
        n = {
  ...
  _onDragMove: function _onDragMove() {
  ...
  _drawTimeline: function _drawTimeline(t) {
  ...
  _updateDrawTimeline: function _updateDrawTimeline(t) {
    var e = !1;
  ...
  setRowPosition: function setRowPosition(t, e) {
    this.setPosition({
      top: t
    }), this._el.timespan.style.height = e + "px";
  },
  _onMarkerClick: function _onMarkerClick() {
    ...
    if (this._el.container = TL.Dom.create("div", "tl-timemarker"), this.data.unique_id && (this._el.container.id = this.data.unique_id + "-marker"), this.data.end_date && (this.has_end_date = !0, this._el.container.className = "tl-timemarker tl-timemarker-with-end"), this._el.timespan = TL.Dom.create("div", "tl-timemarker-timespan", this._el.container), this._el.timespan_content = TL.Dom.create("div", "tl-timemarker-timespan-content", this._el.timespan), this._el.content_container = TL.Dom.create("div", "tl-timemarker-content-container", this._el.container), this._el.content = TL.Dom.create("div", "tl-timemarker-content", this._el.content_container), this._el.line_left = TL.Dom.create("div", "tl-timemarker-line-left", this._el.timespan), this._el.line_right = TL.Dom.create("div", "tl-timemarker-line-right", this._el.timespan), this.data.media) {
      ...
      var t = {
        url: this.data.media.thumbnail
          ...
          e = this.data.media.thumbnail ? TL.MediaType(t, !0) : null;
  ...
  setAlternateRowColor: function setAlternateRowColor(t, e) {
    var i = "tl-timegroup";
  ...
  _computeDefaultSpan: function _computeDefaultSpan(t) {
    if ("human" == t.scale) {
  ...
  getPositionInfo: function getPositionInfo(t) {
  ...
  _assessGroups: function _assessGroups(t) {
  ...
  _computeRowInfo: function _computeRowInfo(t, e) {
  ...
  _computePositionInfo: function _computePositionInfo(t, e, i) {
    i = i || 100;
    ...
    if (n.length) {
      ...
      for (var s = 0; s < this._positions.length; s++) {
        ...
        for (var h = l[o.group], d = h.positions.length - 1; d >= 0; d--) {
          h.positions[d].end > o.start && h.n_overlaps++;
        }
  ...
  initialize: function initialize(t, e) {
    this._el = {
      ...
      eon: "compact",
      eon2: "compact"
    }, this._el.container = "object" == _typeof(t) ? t : TL.Dom.get(t), TL.Util.mergeData(this.options, e), this._initLayout(), this._initEvents();
  },
  show: function show() {},
  hide: function hide() {},
  addTo: function addTo(t) {
  ...
  drawTicks: function drawTicks(t, e) {
    {
      var i = t.getTicks();
      ({
        minor: {
  ...
  _createTickElements: function _createTickElements(t, e, i, n) {
    e.innerHTML = "";
    var a = {},
        s = new Date(-1, 13, -30);
    if (a[s.getTime()] = !0, n) for (var o = 0; o < n.length; o++) {
      a[n[o].getTime()] = !0;
    }
    ...
    for (var r = [], o = 0; o < t.length; o++) {
      ...
      if (!(l.getTime() in a)) {
        var h = TL.Dom.create("div", "tl-timeaxis-tick", e),
            d = TL.Dom.create("span", "tl-timeaxis-tick-text tl-animate-opacity", h);
  ...
  positionTicks: function positionTicks(t, e, i) {
  ...
  _positionTickArray: function _positionTickArray(t, e, i) {
    if (t[1] && t[0]) {
  ...
  getPixelsPerTick: function getPixelsPerTick(t) {
    return t * this.minor.factor;
  },
  getMajorTicks: function getMajorTicks(t) {
    return this._getTicks(t, this.major);
  },
  getMinorTicks: function getMinorTicks(t) {
    return this._getTicks(t, this.minor);
  },
  _getTicks: function _getTicks(t, e) {
    for (var i = t._scaled_padding * e.factor, n = t._earliest - i, a = t._latest + i, s = [], o = n; a > o; o += e.factor) {
      s.push(t.getDateFromTime(o).floor(e.name));
    }
  ...
  initialize: function initialize(t, e, i) {
    ...
    if (i || (i = {}), this.version = "3.2.6", this.ready = !1, this._el = {
      ...
      timenav: {},
      menubar: {}
    }, this._el.container = "object" == _typeof(t) ? t : TL.Dom.get(t), this._storyslider = {}, this._style_sheet = new TL.StyleSheet(), this._timenav = {}, this._menubar = {}, this._loaded = {
      storyslider: !1,
      timenav: !1
    ...
    TL.Util.mergeData(this.options, i), window.addEventListener("resize", function () {
      ...
      var e = t.key,
          i = n._getSlideIndex(n.current_id),
          a = n.config.events.length - 1,
          s = n.config.title ? a + 1 : a,
          o = 0;
  ...
  getDataById: function getDataById(t) {
  ...
  getSlideById: function getSlideById(t) {
  ...
  _calculateTimeNavHeight: function _calculateTimeNavHeight(t, e) {
    var i = 0;
  ...
  _updateHashBookmark: function _updateHashBookmark(t) {
  ...
  _initData: function _initData(t) {
    var e = this;
  ...
  setConfig: function setConfig(t) {
    if (this.config = t, this.config.validate(), this._validateOptions(), this.config.isValid()) try {
      ...
      for (var i = [], n = 0, a = this.config.getErrors(); n < a.length; n++) {
        i.push(this._translateError(a[n]));
      }
  ...
  _getSlideIndex: function _getSlideIndex(t) {
  ...
  _onTimeNavChange: function _onTimeNavChange(t) {
  ...
  _onBackToStart: function _onBackToStart() {
  ...
  _onStorySliderNext: function _onStorySliderNext(t) {
    this.fire("nav_next", t);
  },
  _onStorySliderPrevious: function _onStorySliderPrevious(t) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../static/timeline3/js/timeline-min.js"], null)
//# sourceMappingURL=/timeline-min.144c32c5.js.map